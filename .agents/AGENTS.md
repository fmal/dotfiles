...
- Browser automation: prefer `playwright-cli` over other browser skills for testing, UI checks and QA. For my real browser (Helium), start with `~/.dotfiles/bin/pw-attach [URL]`.
